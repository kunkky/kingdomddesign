...
<section data-bs-version="5.1" class="form2 cid-tdhFqFlM1N mbr-fullscreen" id="form2-d">
    ...
    <div class="container-fluid">
        ...
        <div class="col-md-4 formbody">
            ...
            @csrf
    <h1 class="h3 mb-3 fw-normal">Please Contributor sign in</h1>
    ...
    @if (Route::has('password.request'))
                    <a class="underline text-sm text-gray-600 hover:text-gray-900" href="{{ route('contributor.password.request') }}">
